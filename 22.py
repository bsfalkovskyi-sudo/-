...
<body>
  <div class="card">
    <h1 id="authTitle">Вхід у Gateway</h1>
  ...
  <script>
    ...
    function toggleAuthMode(isRegister) {
      ...
      authTitle.textContent = isRegister ? "Реєстрація у Gateway" : "Вхід у Gateway";
    }
    ...
    document.getElementById("registerBtn").addEventListener("click", async () => {
      ...
      if (!res.ok) {
        err.textContent = "Не вдалося подати заявку. Можливо, такий користувач вже існує.";
        err.style.display = "block";
        return;
      }
...
<body>
  ...
  <div class="modal-backdrop" id="soundModalBackdrop" role="dialog" aria-modal="true" aria-labelledby="soundModalTitle">
    <div class="modal">
      ...
      <div id="adminUsersSection" style="display:none; margin-top:12px; border-top:1px solid var(--panel-border); padding-top:10px;">
